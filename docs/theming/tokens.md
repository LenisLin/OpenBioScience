...
This is the canonical list of semantic design tokens used by DeepOrganiser's theming system.
...
> 这是 DeepOrganiser 主题系统的语义 Token 权威清单。一个 **Theme** 可以通过可选的 `tokens` 映射
