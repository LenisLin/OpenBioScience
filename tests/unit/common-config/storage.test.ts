...
describe('storage runtime exports', () => {
  ...
  describe('EnvStorage', () => {
    ...
    it('set/get roundtrip with deeporganiser.dir object', async () => {
      const dirs = {
        workDir: '/a',
        cacheDir: '/b',
        dataDir: '/c',
      ...
      await EnvStorage.set('deeporganiser.dir', dirs);
      const result = await EnvStorage.get('deeporganiser.dir');
  ...
  describe('storage isolation', () => {
    it('ConfigStorage and EnvStorage do not share state', async () => {
      ...
      await EnvStorage.set('deeporganiser.dir', {
        workDir: '/x',
        cacheDir: '/y',
        dataDir: '/z',
        homeDir: '/h',
      ...
      const envDir = await EnvStorage.get('deeporganiser.dir');
