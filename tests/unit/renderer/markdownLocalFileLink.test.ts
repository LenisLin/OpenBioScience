...
describe('resolveLocalFileLinkPath', () => {
  it('recognizes Windows absolute paths emitted as root-relative markdown links', () => {
    expect(resolveLocalFileLinkPath('/C:/Users/Administrator/AppData/Roaming/DeepOrganiser/report.xlsx')).toBe(
      'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/report.xlsx'
    );
  });
  ...
  it('recognizes file-like POSIX absolute paths outside common home and temp roots', () => {
    expect(resolveLocalFileLinkPath('/opt/deeporganiser/outputs/report.xlsx')).toBe('/opt/deeporganiser/outputs/report.xlsx');
  });

  it('recognizes line suffixes without confusing Windows drive letters', () => {
    const reference = resolveLocalFileLinkReference(
      'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log:1421'
    );

    expect(reference).toEqual({
      filePath: 'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log',
      rawReference: 'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log:1421',
      line: 1421,
    });
    expect(resolveLocalFileLinkPath('C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log:1421')).toBe(
      'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log'
    );
  });

  it('recognizes line and column suffixes without including the line in the file path', () => {
    const reference = resolveLocalFileLinkReference(
      'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log:1421:7'
    );

    expect(reference).toEqual({
      filePath: 'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log',
      rawReference: 'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log:1421:7',
      line: 1421,
      column: 7,
    });
    expect(
      resolveLocalFileLinkPath('C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log:1421:7')
    ).toBe('C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log');
  });
  ...
  it('formats local file paths as file URLs for browser link copying', () => {
    expect(toLocalFileHref('C:/Users/Administrator/AppData/Roaming/DeepOrganiser/report.xlsx')).toBe(
      'file:///C:/Users/Administrator/AppData/Roaming/DeepOrganiser/report.xlsx'
    );
