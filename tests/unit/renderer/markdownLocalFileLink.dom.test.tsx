...
describe('MarkdownView local file links', () => {
  ...
  it('renders local file links as app controls instead of browser anchors', () => {
    ...
    render(
      <MarkdownView onLocalFileLink={onLocalFileLink}>
        {'[report.xlsx](/C:/Users/Administrator/AppData/Roaming/DeepOrganiser/report.xlsx)'}
      </MarkdownView>
    );
    ...
    expect(onLocalFileLink).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        filePath: 'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/report.xlsx',
      })
    );

    fireEvent.click(screen.getByRole('button', { name: 'Copy' }));
    expect(copyTextMock).toHaveBeenCalledWith('C:/Users/Administrator/AppData/Roaming/DeepOrganiser/report.xlsx');
  });
  ...
  it('renders line references as file chips and copies the full reference', () => {
    ...
    render(
      <MarkdownView onLocalFileLink={onLocalFileLink}>
        {'[2026-06-19.log](C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/2026-06-19.log:1421)'}
      </MarkdownView>
    );
    ...
    expect(onLocalFileLink).toHaveBeenCalledWith(
      'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/2026-06-19.log',
      expect.objectContaining({
        filePath: 'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/2026-06-19.log',
        rawReference: 'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/2026-06-19.log:1421',
        line: 1421,
      })
    );
    ...
    expect(copyTextMock).toHaveBeenCalledWith(
      'C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/2026-06-19.log:1421'
    );
  });
  ...
  it('renders line and column references as file chips and copies the full reference', () => {
    ...
    render(
      <MarkdownView onLocalFileLink={onLocalFileLink}>
        {'[app.log](C:/Users/Administrator/AppData/Roaming/DeepOrganiser/logs/app.log:1421:7)'}
      </MarkdownView>
    );
