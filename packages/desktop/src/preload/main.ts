...
// Synchronously fetch the DeepOrganiser Core port and expose it to the renderer
...
contextBridge.exposeInMainWorld('__deeporganiserE2ETest', process.env.DEEPORGANISER_E2E_TEST === '1');
