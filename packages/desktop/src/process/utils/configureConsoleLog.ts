 ...
 *   - macOS:   ~/Library/Logs/DeepOrganiser/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\DeepOrganiser\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/DeepOrganiser/logs/YYYY-MM-DD.log
 *
...
const BACKEND_PREFIX = '[deeporganiser-core]';
