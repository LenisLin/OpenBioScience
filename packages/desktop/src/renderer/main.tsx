  ...
  void import('@sentry/electron/renderer')
    .then((Sentry) => {
      Sentry.withScope((scope) => {
        scope.setTag('deeporganiser.installation_integrity', event.failure_kind ?? 'unknown');
        scope.setTag('deeporganiser.runtime_resource', event.resource);
        scope.setTag('deeporganiser.runtime_resource_id', event.resource_id ?? '');
        scope.setTag('deeporganiser.runtime_scope', event.scope.kind);
