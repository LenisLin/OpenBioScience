...
const SKILLS_MARKET_DETAILS_ZH = 'https://github.com/ResearAI/OpenScience/discussions/1326';
const SKILLS_MARKET_DETAILS_EN = 'https://github.com/ResearAI/OpenScience/discussions/1325';
