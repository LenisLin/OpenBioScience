...
type UseCustomAgentsLoaderResult = {
  /**
   * Preset assistant catalog returned by the backend. Kept only for legacy
   * conversation defaults; no dedicated assistant picker is rendered.
   */
