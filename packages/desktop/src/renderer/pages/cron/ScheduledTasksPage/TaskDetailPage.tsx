...
const TaskDetailPage: React.FC = () => {
  ...
  const instructionsText = job.target?.payload?.text || '-';
  const agentConfig = job.metadata?.agent_config;
          ...
          <div className='flex flex-wrap items-center gap-10px md:gap-12px'>
            ...
            {nextRunAt && (
              <span className='text-14px text-t-secondary'>
                {t('cron.nextRun')} {formatNextRun(nextRunAt)}
              </span>
            )}
          </div>
          ...
          <aside data-testid='task-detail-sidebar-column' className='flex min-w-0 flex-col gap-24px'>
            ...
            {agentConfig?.model_id && (
              <section className='flex flex-col gap-10px'>
                ...
                <span className='break-words text-14px leading-22px text-t-primary'>{agentConfig.model_id}</span>
              </section>
            )}
            ...
            {agentConfig?.workspace && (
              <section className='flex flex-col gap-10px'>
                ...
                <span className='min-w-0 break-all text-14px leading-22px text-t-primary'>{agentConfig.workspace}</span>
              </section>
            )}
            ...
            {agentConfig?.config_options && Object.keys(agentConfig.config_options).length > 0 && (
              <section className='flex flex-col gap-10px'>
                ...
                <span className='break-words text-14px leading-22px text-t-primary'>
                  {Object.values(agentConfig.config_options).join(', ')}
                </span>
              </section>
            )}
          </aside>
