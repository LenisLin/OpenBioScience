...
export const WORKSPACE_EXPANSION_STORAGE_KEY = 'deeporganiser_workspace_expansion';
export const WORKSPACE_EXPANSION_EVENT = 'deeporganiser:workspace-expansion-changed';
