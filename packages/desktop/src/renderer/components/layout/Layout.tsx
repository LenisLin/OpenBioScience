...
const Layout: React.FC<{
  ...
  useEffect(() => {
    ...
    const handleCheckUpdate = () => {
      window.dispatchEvent(new CustomEvent('deeporganiser-open-update-modal', { detail: { source: 'tray' } }));
    };
      ...
      <NavigationHistoryProvider>
        <div className='app-shell flex flex-col size-full min-h-0'>
          ...
          <ArcoLayout className={'size-full layout flex-1 min-h-0'}>
            ...
            >
              <ArcoLayout.Header
                className={classNames(
                  'flex items-center justify-start pt-10px pb-10px pl-16px pr-16px gap-8px layout-sider-header',
            ...
            <ArcoLayout.Content
              className={'bg-1 layout-content relative flex flex-col min-h-0 overflow-hidden'}
              onClick={() => {
            ...
            >
              ...
              <CollaborationWebviewPool activeRoute={isCollaborationRoute} />
            </ArcoLayout.Content>
          </ArcoLayout>
        </div>
      </NavigationHistoryProvider>
