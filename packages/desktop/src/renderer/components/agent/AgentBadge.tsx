...
/** Agent identity badge (logo + name). */
const AgentBadge: React.FC<AgentBadgeProps> = ({ backend, agent_name, agentLogo, agentLogoIsEmoji }) => {
  return (
    <div className='flex items-center gap-2 bg-2 w-fit rounded-full px-[8px] py-[2px]' data-testid='agent-badge'>
      <AgentLogoIcon
        backend={backend}
