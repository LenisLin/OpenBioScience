...
type CommandQueuePanelProps = {
  ...
  onGuide?: (item: ConversationCommandQueueItem) => void;
    ...
    >
      ...
      <div className='flex items-center gap-0.5 shrink-0'>
        {renderQueueActionIconButton({
          ariaLabel: t('conversation.commandQueue.guide', { defaultValue: 'Guide' }),
          onClick: () => onGuide?.(item),
          icon: <CornerDownRight theme='outline' size='14' strokeWidth={2.5} />,
          disabled: !onGuide,
        })}
        {renderQueueActionIconButton({
