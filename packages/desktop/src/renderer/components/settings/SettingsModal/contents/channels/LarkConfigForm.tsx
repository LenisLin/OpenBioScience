...
import { CloseOne, Copy, Delete, Down } from '@icon-park/react';
...
const LarkConfigForm: React.FC<LarkConfigFormProps> = ({ pluginStatus, modelSelection, onStatusChange }) => {
  ...
  const handleTestConnection = async () => {
    ...
    try {
      ...
      Message.error(error instanceof Error ? error.message : t('settings.lark.connectionFailed', 'Connection failed'));
    } finally {
  ...
  const agentOptions: Array<{
    ...
    name: string;
    id?: string;
  }> = availableAgents.length > 0 ? availableAgents : [DEFAULT_NEW_CONVERSATION_AGENT];
      ...
      {!hasExistingUsers && !pluginStatus?.connected && (
        <div className='flex justify-end'>
          ...
          <Button
            ...
            icon={<CollaborationIcon name='apiBinding' size={21} />}
            loading={testLoading}
        ...
        >
          ...
          >
            <Button type='secondary' className='min-w-160px flex items-center justify-between gap-8px'>
              <span className='truncate flex items-center gap-6px min-w-0'>
                <CollaborationIcon name='message' size={20} />
          ...
          <SectionHeader
            ...
            action={
              <Button
                size='mini'
                type='text'
                icon={<CollaborationIcon name='refreshSync' size={20} spin={pairingLoading} />}
                ...
                <div key={pairing.code} className='flex items-center justify-between bg-fill-2 rd-8px p-12px'>
                  ...
                  <div className='flex items-center gap-8px'>
                    <Button
                      ...
                      className='collaboration-light-primary'
                      size='small'
                      icon={<CollaborationIcon name='connected' size={20} />}
          ...
          <SectionHeader
            ...
            action={
              <Button
                size='mini'
                type='text'
                icon={<CollaborationIcon name='refreshSync' size={20} spin={usersLoading} />}
