...
const AionModal: React.FC<AionModalProps> = ({
  ...
  return (
    <Modal
      ...
      footer={null}
      onCancel={onCancel}
      className={`deeporganiser-modal ${className}`}
      style={finalStyle}
      getPopupContainer={() => document.body}
    >
      <div className='deeporganiser-modal-wrapper' style={{ borderRadius: borderRadiusVal }}>
        {renderHeader()}
        <div className='deeporganiser-modal-body-content' style={bodyInlineStyle}>
          {children}
        </div>
        {renderFooter()}
      </div>
