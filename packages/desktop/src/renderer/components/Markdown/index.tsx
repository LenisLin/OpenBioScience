...
type MarkdownViewProps = {
  ...
  onLinkPreview?: (href: string, label?: string) => void | Promise<void>;
            ...
            return (
              <a
                ...
                className={classNames(
                  'inline-flex max-w-full items-baseline gap-4px align-baseline text-brand hover:text-brand-hover',
                  anchorProps.className
                )}
              >
                <LinkCloud theme='outline' size='14' className='relative top-2px flex-shrink-0' />
                <span className='truncate'>{anchorProps.children}</span>
              </a>
            );
          }
          return (
