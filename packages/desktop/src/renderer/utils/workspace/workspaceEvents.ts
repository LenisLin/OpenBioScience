export const WORKSPACE_TOGGLE_EVENT = 'deeporganiser-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'deeporganiser-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'deeporganiser-workspace-has-files';
