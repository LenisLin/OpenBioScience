...
export const STORAGE_KEYS = {
  ...
  WORKSPACE_TREE_COLLAPSE: 'deeporganiser_workspace_collapse_state',

  /** Sidebar collapse state / 侧边栏折叠状态 */
  SIDEBAR_COLLAPSE: 'deeporganiser_sider_collapsed',

  /** Theme preference / 主题偏好 */
  THEME: 'deeporganiser_theme',

  /** Language preference / 语言偏好 */
  LANGUAGE: 'deeporganiser_language',
} as const;
