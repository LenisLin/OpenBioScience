// Core types for @deeporganiser/web-host (M3 interface contract, locked for M4-M8)
...
/**
 * System dirs exported to the backend via DEEPORGANISER_{CACHE,WORK,LOG}_DIR env.
