...
2. 用户可通过飞书机器人与 DeepScientist-Pro 进行对话
...
| ------------ | ----------------------------------------- |
| 配对码认证   | 6位随机码，10分钟有效                     |
| 本地批准     | 必须在 DeepScientist-Pro 中批准，非飞书中 |
| 用户白名单   | 仅授权用户可使用                          |
| 速率限制     | 防止滥用                                  |
