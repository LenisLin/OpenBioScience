---
name: cs-remote-compute-ssh
description: "Submit→wait_for_notification→harvest workflow for the user's SSH/SLURM hosts. Load once you've decided to dispatch remote. OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/academicforge/skills/claude-science/remote-compute-ssh -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream AcademicForge Claude Science skill `remote-compute-ssh`. Use it as domain workflow knowledge inside Science Mode.
...
- Source path: `resources/skills/vendor/academicforge/skills/claude-science/remote-compute-ssh`
- Original description: Submit→wait_for_notification→harvest workflow for the user's SSH/SLURM hosts. Load once you've decided to dispatch remote.
