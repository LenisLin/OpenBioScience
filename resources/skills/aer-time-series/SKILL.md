---
name: aer-time-series
description: "| OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/auto-empirical-research-skills/skills/67-econfin-workflow-toolkit/time-series -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream Auto-Empirical Research Skills skill `time-series`. Use it as domain workflow knowledge inside Science Mode.
...
- Source path: `resources/skills/vendor/auto-empirical-research-skills/skills/67-econfin-workflow-toolkit/time-series`
...
- **panel-data**: For panel data with both cross-sectional and time dimensions
- **ols-regression**: For cross-sectional analysis without time dependence
- **/diagnose**: Run time series diagnostics (stationarity, ARCH effects, stability)
- **/robustness**: Test robustness to lag length, sample period, and model specification
- **/plot**: Create time series plots, ACF/PACF diagrams, and IRF charts
