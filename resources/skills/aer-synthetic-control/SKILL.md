---
name: aer-synthetic-control
description: "| OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/auto-empirical-research-skills/skills/67-econfin-workflow-toolkit/synthetic-control -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream Auto-Empirical Research Skills skill `synthetic-control`. Use it as domain workflow knowledge inside Science Mode.
...
- Source path: `resources/skills/vendor/auto-empirical-research-skills/skills/67-econfin-workflow-toolkit/synthetic-control`
...
- **did-analysis**: DID is the most common alternative; consider SCM when few treated units exist
- **matching**: Matching methods as complementary approach for causal inference
- **/robustness**: Generate additional robustness checks for SCM results
- **/method**: Write up the synthetic control methodology section
- **/plot**: Create publication-quality SCM plots
