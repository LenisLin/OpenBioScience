---
name: kdense-sympy
description: "Use when you need exact symbolic math in Python — algebra, calculus, equation solving, symbolic linear algebra, or code generation via lambdify/LaTeX. Prefer NumPy or SciPy when floating-point approximations are sufficient. OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/scientific-agent-skills/skills/sympy -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream K-Dense scientific-agent-skills skill `sympy`. Use it as domain workflow knowledge inside Science Mode.
...
- Execution policy: `available_default`; risk: `write`; license: `https://github.com/sympy/sympy/blob/master/LICENSE`.
...
- Source path: `resources/skills/vendor/scientific-agent-skills/skills/sympy`
- Original description: Use when you need exact symbolic math in Python — algebra, calculus, equation solving, symbolic linear algebra, or code generation via lambdify/LaTeX. Prefer NumPy or SciPy when floating-point approximations are sufficient.
