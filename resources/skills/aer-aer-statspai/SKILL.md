---
name: aer-aer-statspai
description: "Use when implementing or running the empirical analysis for an AER-track manuscript with StatsPAI — the agent-native unified Python engine and MCP server for causal inference and econometrics — as an alternative to hand-written Stata / R / Python template code. Covers DiD, IV, RDD, synthetic control, robustness, sensitivity, and publication-ready table export. OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/auto-empirical-research-skills/skills/50-brycewang-aer-skills/skills/aer-statspai -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream Auto-Empirical Research Skills skill `aer-statspai`. Use it as domain workflow knowledge inside Science Mode.
...
- Source path: `resources/skills/vendor/auto-empirical-research-skills/skills/50-brycewang-aer-skills/skills/aer-statspai`
- Original description: Use when implementing or running the empirical analysis for an AER-track manuscript with StatsPAI — the agent-native unified Python engine and MCP server for causal inference and econometrics — as an alternative to hand-written Stata / R / Python template code. Covers DiD, IV, RDD, synthetic control, robustness, sensitivity, and publication-ready table export.
