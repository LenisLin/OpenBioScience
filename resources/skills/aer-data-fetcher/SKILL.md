---
name: aer-data-fetcher
description: "Fetch economic data from FRED, World Bank, BLS, OECD, and Yahoo Finance OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/auto-empirical-research-skills/skills/67-econfin-workflow-toolkit/data-fetcher -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream Auto-Empirical Research Skills skill `data-fetcher`. Use it as domain workflow knowledge inside Science Mode.
...
- Source path: `resources/skills/vendor/auto-empirical-research-skills/skills/67-econfin-workflow-toolkit/data-fetcher`
- Original description: Fetch economic data from FRED, World Bank, BLS, OECD, and Yahoo Finance
