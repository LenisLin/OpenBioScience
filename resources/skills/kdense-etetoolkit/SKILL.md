---
name: kdense-etetoolkit
description: "Phylogenetic tree toolkit (ETE). Tree manipulation (Newick/NHX), evolutionary event detection, orthology/paralogy, NCBI taxonomy, visualization (PDF/SVG), for phylogenomics. OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/scientific-agent-skills/skills/etetoolkit -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream K-Dense scientific-agent-skills skill `etetoolkit`. Use it as domain workflow knowledge inside Science Mode.
...
- Execution policy: `quarantined_script`; risk: `external_compute`; license: `GPL-3.0 license`.
...
- Source path: `resources/skills/vendor/scientific-agent-skills/skills/etetoolkit`
- Original description: Phylogenetic tree toolkit (ETE). Tree manipulation (Newick/NHX), evolutionary event detection, orthology/paralogy, NCBI taxonomy, visualization (PDF/SVG), for phylogenomics.
