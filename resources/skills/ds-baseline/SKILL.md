---
name: ds-baseline
description: "Use when a quest needs to attach, import, reproduce, repair, verify, compare, or publish a baseline and its metrics. OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/deepscientist-1.6.0/src/skills/baseline -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream DeepScientist v1.6.0 skill `baseline`. Use it as domain workflow knowledge inside Science Mode.
...
- Source path: `resources/skills/vendor/deepscientist-1.6.0/src/skills/baseline`
- Original description: Use when a quest needs to attach, import, reproduce, repair, verify, compare, or publish a baseline and its metrics.
