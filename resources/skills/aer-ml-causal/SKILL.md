...
<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/auto-empirical-research-skills/skills/67-econfin-workflow-toolkit/ml-causal -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream Auto-Empirical Research Skills skill `ml-causal`. Use it as domain workflow knowledge inside Science Mode.
...
- Source path: `resources/skills/vendor/auto-empirical-research-skills/skills/67-econfin-workflow-toolkit/ml-causal`
...
- **iv-estimation**: DML can be combined with IV for endogenous treatment
- **did-analysis**: ML methods can complement DID for heterogeneity analysis
- **matching**: AIPW is closely related to DML
- **/robustness**: Compare ML-based and traditional estimates
- **/diagnose**: Check model diagnostics after estimation
