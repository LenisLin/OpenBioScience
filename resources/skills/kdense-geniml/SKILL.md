---
name: kdense-geniml
description: "This skill should be used when working with genomic interval data (BED files) for machine learning tasks. Use for training region embeddings (Region2Vec, BEDspace), single-cell ATAC-seq analysis (scEmbed), building consensus peaks (universes), or any ML-based analysis of genomic regions. Applies to BED file collections, scATAC-seq data, chromatin accessibility datasets, and region-based genomic feature learning. OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/scientific-agent-skills/skills/geniml -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream K-Dense scientific-agent-skills skill `geniml`. Use it as domain workflow knowledge inside Science Mode.
...
- Execution policy: `restricted_default`; risk: `credential`; license: `BSD-2-Clause license`.
...
- Source path: `resources/skills/vendor/scientific-agent-skills/skills/geniml`
