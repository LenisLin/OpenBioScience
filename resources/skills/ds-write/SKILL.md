---
name: ds-write
description: "Use when a quest has enough evidence to draft or refine a paper, report, or research summary without inventing missing support. OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/deepscientist-1.6.0/src/skills/write -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream DeepScientist v1.6.0 skill `write`. Use it as domain workflow knowledge inside Science Mode.
...
- Source path: `resources/skills/vendor/deepscientist-1.6.0/src/skills/write`
- Original description: Use when a quest has enough evidence to draft or refine a paper, report, or research summary without inventing missing support.
