---
name: ds-paper-outline
description: "Use when creating, revising, validating, or repairing a research-paper outline before writing; turns experiment evidence into a clear paper idea, scoped claims, method abstraction, evaluation plan, analysis plan, and evidence boundaries without copying run logs into the manuscript. OpenScience: record concrete outputs through science_artifact provenance."
---

<!-- Generated by OpenScience science skill materializer; source=resources/skills/vendor/deepscientist-1.6.0/src/skills/paper-outline -->

# OpenScience Adapter

This is a first-class OpenScience materialization of the upstream DeepScientist v1.6.0 skill `paper-outline`. Use it as domain workflow knowledge inside Science Mode.
...
- Source path: `resources/skills/vendor/deepscientist-1.6.0/src/skills/paper-outline`
- Original description: Use when creating, revising, validating, or repairing a research-paper outline before writing; turns experiment evidence into a clear paper idea, scoped claims, method abstraction, evaluation plan, analysis plan, and evidence boundaries without copying run logs into the manuscript.
