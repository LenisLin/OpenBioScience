# DeepOrganiser Development Justfile
# Usage: just <recipe>
...
preflight:
    ...
    $failed = $false
    Write-Host "=========================================="
    Write-Host "  DeepOrganiser Build Preflight Check"
    Write-Host "=========================================="
    Write-Host ""
...
info:
    #!/usr/bin/env bash
    echo "DeepOrganiser Build Environment"
    echo "========================"
...
build-win: preflight
    ...
    Get-Process -Name "DeepOrganiser","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue
