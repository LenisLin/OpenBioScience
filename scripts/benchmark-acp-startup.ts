...
function getLogFilePath(): string {
  ...
  // Dev mode uses "DeepOrganiser-Dev", production uses "DeepOrganiser"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'DeepOrganiser-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'DeepOrganiser', `${today}.log`);
