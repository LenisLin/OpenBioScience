...
Environment variables:
  ...
  MANAGED_ACP_CDN_BASE         Optional. Public CDN base. Default: https://openscience.cc/managed/acp
...
MANAGED_ACP_CDN_BASE="${MANAGED_ACP_CDN_BASE:-https://openscience.cc/managed/acp}"
