...
function printTerminalReport(report: BenchReport): void {
  console.log('\n  ╔══════════════════════════════════════════════════════════════╗');
  console.log('  ║              DeepOrganiser Performance Benchmark Report            ║');
  console.log('  ╚══════════════════════════════════════════════════════════════╝');
...
<head>
<meta charset="utf-8">
<title>DeepOrganiser Benchmark Report - ${report.timestamp}</title>
<style>
...
<body>
<h1>DeepOrganiser Performance Benchmark Report</h1>
<div class="meta">
